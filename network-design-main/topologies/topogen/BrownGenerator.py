...
def field_gen(q):
    ...
    #print_mat(add_mat, q, q)
    #print_mat(mul_mat, q, q)
...
class BrownGenerator(TopologyGenerator):
    ...
    def make(self, q : int):
        ...
        print("# vertices = " + str(len(vectors)))


        for idx,v in enumerate(vectors):
            node_map[v] = idx
            #print("vector = {" + str(v) + "}, idx = " + str(idx))
        ...
        #    print("central vertex = " + str(idx-1) + ", degree = " + str(len(graph[src])))
