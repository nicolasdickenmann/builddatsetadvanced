...
public class FromFileGraphGenerator implements GraphGenerator {
    ...
    public SelectorResult<Graph> generate(String[] args) {
        ...
        addOption(options, "p", "number of endpoints attached to a router (concentration)");
        ...
        int concentration = Integer.parseInt(cmd.getOptionValue("p"));
        ...
        // Create graph
        return new SelectorResult<>(new FileBidirGraph(switches, partSwitches, concentration, file), cmd.getArgs());
