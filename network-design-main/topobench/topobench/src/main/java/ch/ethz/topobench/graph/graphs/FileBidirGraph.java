...
public class FileBidirGraph extends Graph {
     ...
     * @param concentration Nnmber of endpoints attached to a router
     * @param filename      File name
     */
    public FileBidirGraph(int n, int partSwitches, int concentration, String filename) {
        super("file", n, 0);
        ...
        try {
            ...
            // Simply read in the server pairsu
            String strLine;
            int doubles = 0;
            int edges = 0;
            ...
            for (int i = 0; i < partSwitches; i++) {
                this.setNodeWeight(i, concentration);
            }
