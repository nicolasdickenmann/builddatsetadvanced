...
import ch.ethz.topobench.graph.subgraphs.PriorityWeightedAlgorithm;
...
public class PriorityWeightedAlgorithmGenerator implements SubgraphsGeneratorGenerator {
    @Override
    public SelectorResult<SubgraphsGenerator> generate(Graph graph, String[] args) {
        ...
        return new SelectorResult<>(new PriorityWeightedAlgorithm(layers, M, minLength, diam, threads, graph, produceLayers), cmd.getArgs());
    }
}
