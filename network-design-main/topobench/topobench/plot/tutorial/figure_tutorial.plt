...
set terminal x11 font "Gill Sans, 16" linewidth 1.8 rounded dashed
...
set output "figure_tutorial.pdf"
...
plot "../../results/tutorial/tutorial.txt" using 9:($10 > 1 ? 1 : $10) title "JellyFish"  w lp ls 2
