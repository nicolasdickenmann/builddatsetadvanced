...
for switches in 98 242 338 578
do
...
do
   ...
   for M in $(($switches * 3 / 2)) $(($switches * 2)) $(($switches *5 / 4 )) $(($switches))
   do
    ...
    do
        ...
        do
            ...
            do
                    ...
                    -eval $evaluator -div $division -layers $layersNumber -M $M -diam 2 -minLength 3 -threads 8 -produce 1 -tfr $trafficFrac
