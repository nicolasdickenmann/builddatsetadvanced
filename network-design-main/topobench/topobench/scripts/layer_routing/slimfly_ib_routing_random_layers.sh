...
division=RANDOM_DAGS      # SPAIN = Use SPAIN algorithm
...
tmode=RPP              # RPP = Rand. Permutation Pairs,
                        # ATA = All-to-All,
                        # AT1 = All-to-One,
                        # STR = Stride,
...
for switches in 98 242 338
do
    for layersNumber in 1 2 3 4 6 8 #${hashmap["$switches"]}
do
    ...
    do
        ...
        do
            ...
            do
                    ...
                    -eval $evaluator -div $division -layers $layersNumber -frac $frac -threads 8 -produce 1 -tfr $trafficFrac
            ...
            echo "$patheval $topology $switches $layersNumber $frac $fraction $tmode $trafficFrac $avgstdflow $time_taken" >> ../../results/layer_routing/${tmode}_slimfly_pw_1.txt
        done
    done
        ...
        # Executing NRUNS times, store each resulting flow into flowtmp_tutorial
            ...
            do
                    ...
                    -gt $topology -pe $patheval -tm $tmode \
                    -switches $switches -partswitches $switches -filename $filename -p $fraction  \
                    -eval $evaluator -div $division -layers $layersNumber -frac $frac -threads 8 -produce 1
